...
public class ThrowsExam {
	...
	/**
	 * createNewInstance("com.ktdsuniversity.edu.exceptions.ExceptionExam")
	 * ==> Customer의 인스턴스가 반환
	 * 클래스 경로를 적어주면 reflection이라는 스킬. 공통만들 때 많이 사용
	 * @param classPath
	 * @return
	 */
	...
	public static Object createNewInstance2(String classPath) throws ClassNotFoundException, NoSuchMethodException,
		...
		if (clazz != null) {
			Constructor constructor = null;
			// 생성자 가져오기
			constructor = clazz.getConstructor(String.class, int.class, int.class);

			if (constructor != null) {
				// 생성자 호출
				Object instance = constructor.newInstance("리플렉션", 100, 100);
				return instance;
			}
		}
	...
	public static void main(String[] args) {
		Item item = ((Item) createNewInstance("com.ktdsuniversity.edu.vendingmachine.item.Item"));

		try {
			Item item2 = ((Item) createNewInstance2("com.ktdsuniversity.edu.vendingmachine.item.Item"));
